      ...
      <Container className={classes.footer_container}>
        <Grid container>
          <Grid
            ...
            lg={4}
            xl={4}
            className={classes.footer_top_item}>
            <h6>MAIN MENU</h6>
            <Divider />
            <ul>
              <li>
          ...
          <Grid
            ...
            <ul>
              <li>
                <NavLink to="/">SIZING CHART</NavLink>
              </li>
              <li>
                <NavLink to="/">FAQ</NavLink>
              </li>
              <li>
                <NavLink to="/">RETURN EXCHANGE POLICY</NavLink>
              </li>
              <li>
          ...
          <Grid
            ...
            <div className={classes.footer_top_item_last}>
        ...
        {/* <Grid container >
                    <ListItemText style={{textAlign:"centrer"}}>item1</ListItemText>
                </Grid> */}
      </Container>
      <Container>
        <Grid container>

...
export const Checkout = () => {
  ...
  return (
    <Grid container justify="flex-start" className={classes.main_container}>
      {/* <Checkout_Right /> */}
      <Grid xs sm md className={classes.left_container}>
        <Container>
          <div className={classes.left_container_heading}>KETNIPZ</div>
          <div>
            <Breadcrumbs
              class={classes.breadcrumbs_container}
          ...
          <div>
            <p className={classes.checkout_subheading}>Contact Information</p>
            ...
            <p className={classes.checkout_subheading}>Shipping Address</p>
            <Grid container>
          ...
          <Grid container className={classes.footer}>
            ...
            <button className={classes.order_btn}>Place Order</button>
          </Grid>
        </Container>
      </Grid>
      <Checkout_Right />
